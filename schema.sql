...
--
-- Table structure for table `account_book_records`
--

DROP TABLE IF EXISTS `account_book_records`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `account_book_records` (
  ...
  PRIMARY KEY (`id`),
  KEY `account_book_records_account_book_id_8914095a_fk_account_b` (`account_book_id`),
  CONSTRAINT `account_book_records_account_book_id_8914095a_fk_account_b` FOREIGN KEY (`account_book_id`) REFERENCES `account_books` (`id`)
...
-- Dump completed on 2023-02-05  0:04:42
